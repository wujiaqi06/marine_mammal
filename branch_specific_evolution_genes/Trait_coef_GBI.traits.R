...
clade_branch <- read.delim("whale.branch.txt")
clade_branch_internal <- clade_branch[clade_branch$Species != "internal",]
hippo <- "B525"
Branch_show <- c(clade_branch_internal$Branch, hippo)
...
Branch_show <- "B593"
label <- "Common ancestor of whale + hippopotamus"
trait_pred.clade <- d0[Branch_show,]
trait_pred.clade
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
Branch_show <- "B544"
label <- "Common ancestor of baleen whales"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade,3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
Branch_show <- "B591"
label <- "Common ancestor of toothed whales"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade,3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
clade_branch <- read.delim("Pinnipeds.branch.txt")
clade_branch_internal <- clade_branch[clade_branch$Species != "internal",]
Branch_show <- clade_branch_internal$Branch
trait_pred.clade <- d0[Branch_show,]
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#1f78b4', 
       pch=16, 
...
Branch_show <- "B410"
label <- "Common ancestor of pinnipeds"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade,3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
#### Common ancestor of Phocidae (earless seals)
clades <- "Pinnipeds"
plot(d0$marine~d0$aquatic, cex = 1, col="#bababa",
     xlab = "Aquatic", ylab = "Marine",
     main = clades,
...
Branch_show <- "B409"
label <- "Common ancestor of Phocidae (earless seals)"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade, 3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
#### Common ancestor of Otarioidea (eared seals + walrus)
clades <- "Pinnipeds"
plot(d0$marine~d0$aquatic, cex = 1, col="#bababa",
     xlab = "Aquatic", ylab = "Marine",
     main = clades,
...
Branch_show <- "B394"
label <- "Common ancestor of Otarioidea (eared seals + walrus)"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade, 3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
#### Common ancestor of Otariidae (eared seals)
clades <- "Pinnipeds"
plot(d0$marine~d0$aquatic, cex = 1, col="#bababa",
     xlab = "Aquatic", ylab = "Marine",
     main = clades,
...
Branch_show <- "B393"
label <- "Common ancestor of Otariidae (eared seals)"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade,3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
...
Branch_show <- "B392"
label <- "Common ancestor of sea lions"
trait_pred.clade <- d0[Branch_show,]
round(trait_pred.clade,3)
points(trait_pred.clade$aquatic, trait_pred.clade$marine, 
       col='#b2182b', 
