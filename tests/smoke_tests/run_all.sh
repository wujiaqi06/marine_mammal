...
Rscript "$ROOT/tests/smoke_tests/check_species_ancestral_source_provenance.R"
Rscript "$ROOT/tests/smoke_tests/check_branch_label_mapper.R"
Rscript "$ROOT/demo/check_extended_source_data.R" --output="$ROOT/demo/output/demo_summary.tsv"
