...
paths <- list(
  ...
  fig6a_profiles = Sys.getenv(
    ...
    unset = file.path(archive_root, "figure4_rebalanced_main", "SourceData_Fig4A_paired_projection_profiles.csv")
  ),
  terminal_only_internal = file.path(root_dir, "reproduction_outputs", "terminal_only_projection", "selected_internal_node_projections.csv"),
  terminal_only_audit = file.path(root_dir, "reproduction_outputs", "terminal_only_projection", "selected_internal_node_target_audit.csv")
)
...
readme <- c(
  ...
  "",
  "This directory was generated by `code/12_species_ancestral_fingerprints/build_FigureS3_ancestor_fingerprints.R`.",
  "",
